                ...
                <div class="pwe-registration__container">
                    ...
                    <div class="pwe-registration__form-section">
                                        ...
                                        <div class="gform-body gform_body">
                                            <div class="gform_fields">
                                                ...
                                                <div class="pwe-registration__row">
                                                    ...
                                                    <div class="gfield gfield--width-full pwe-registration__field-flex">
                                                        <label class="gfield_label gform-field-label">' . PWE_Functions::languageChecker('Numer lokalu', 'Premises number') . '</label>
                                                        <input type="text" id="local" placeholder="' . PWE_Functions::languageChecker('Numer lokalu', 'Premises number') . '" required />
                                                    </div>
                                                </div>
                        ...
                        <div class="pwe-registration__success" style="display: none;">
                            <h2 class="pwe-registration__title pwe-registration__display-after-submit">
                                ' . PWE_Functions::languageChecker('Dziękujemy za przesłanie danych!', 'Thank you for submitting your details!') . '
                            </h2>
                            <p class="pwe-registration__text pwe-registration__display-after-submit">
                                ' . PWE_Functions::languageChecker('Twój darmowy pakiet PLATINIUM wraz z materiałami zostanie wysłany na podany adres.', 'Your free PLATINIUM package will be sent to the provided address.') . '
                            </p>
                            <div class="pwe-registration__buttons">
                    ...
                    <div class="pwe-registration__benefits">
                        <h2 class="pwe-registration__benefits-title">
                            ' . PWE_Functions::languageChecker('Pakiet PLATINIUM upoważnia do:', 'The PLATINIUM package<br/>entitles you to:') . '
                        </h2>
                        ...
                        <div class="pwe-registration__benefit-item">
                            ...
                            <p>' . PWE_Functions::languageChecker('Strefę VIP ROOM', 'VIP ROOM area') . '</p>
                        </div>
                    </div>
