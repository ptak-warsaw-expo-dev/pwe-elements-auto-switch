...
<div id="pweStatistics" class="pwe-statistics">
    <div class="pwe-statistics__wrapper">
        <div class="pwe-statistics__main-tile pwe-statistics__border">
            ...
            <a class="pwe-statistics__btn pwe-main-btn--secondary" href="' . ($b2c ? PWE_Functions::multi_translation("ticket_url") : PWE_Functions::multi_translation("reg_url")) . '">' . ($b2c ? PWE_Functions::multi_translation("buy_ticket") : PWE_Functions::multi_translation("registration")) . '</a>
        </div>
        <div class="pwe-statistics__tiles">
            <div class="pwe-statistics__tiles-visitors pwe-statistics__border">
                ...
                <div class="pwe-statistics__icon-box">
                    <svg class="pwe-statistics__icon pwe-statistics__icon-exhibitor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#FFFFFF">
                ...
                <div class="pwe-statistics__tile-exhibitors pwe-statistics__border">
                    ...
                    <div class="pwe-statistics__icon-box">
                        <svg class="pwe-statistics__icon pwe-statistics__icon-visitor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#FFFFFF">
                            <path d="M360-80v-529q-91-24-145.5-100.5T160-880h80q0 83 53.5 141.5T430-680h100q30 0 56 11t47 32l181 181-56 56-158-158v478h-80v-240h-80v240h-80Zm120-640q-33 0-56.5-23.5T400-800q0-33 23.5-56.5T480-880q33 0 56.5 23.5T560-800q0 33-23.5 56.5T480-720Z"></path>
                        </svg>
                    </div>
                </div>
