...
if (!empty($all_halls)) {
    $output = '
    <div id="pweHalls" class="pwe-halls" data-all-items='. json_encode($json_data_all) .'>
            ...
            <div class="pwe-halls__details">
                <div class="pwe-halls__details-wrapper">
                    <div class="pwe-halls__details-column logo">
                        ...
                        <p class="pwe-halls__date"><strong>'. do_shortcode('[trade_fair_date_multilang]') .'</strong></p>
                    </div>
                    <div class="pwe-halls__details-column info">
                        <div class="pwe-halls__information">
                            ...
                            <p class="pwe-halls__parking">'. PWE_Functions::multi_translation("halls_parking") .'</p>
                        </div>
