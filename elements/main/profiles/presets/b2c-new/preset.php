        ...
        <div class="pwe-profiles__cards">
            <div id="profile_for_visitors" class="pwe-profiles__card" style="background: url('. $profile_for_visitors_img  .'), url(' . $default_visitors_img . ')">
                <div class="pwe-profiles__card-content">
                    <p>'. PWE_Functions::multi_translation("profiles_subtitle") .'</p>
                    <h5>'. PWE_Functions::multi_translation("visitor") .'</h5>
                    <div class="pwe-profiles__show-more-btn">
                        <span>'. PWE_Functions::multi_translation("more_btn") .'</span>
                    ...
                    <div class="pwe-profiles__card-text">'. $profile_for_visitors .'</div>   
                </div>
            </div>
            ...
            <div id="profile_for_exhibitors" class="pwe-profiles__card" style="background: url('. $profile_for_exhibitors_img .'), url(' . $default_exhibitors_img . ')">
                <div class="pwe-profiles__card-content">
                    <p>'. PWE_Functions::multi_translation("profiles_subtitle") .'</p>
                    <h5>'. PWE_Functions::multi_translation("exhibitor") .'</h5>
                    <div class="pwe-profiles__show-more-btn">
                        <span>'. PWE_Functions::multi_translation("more_btn") .'</span>
                        <span class="pwe-profiles__show-more-arrow">
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="pwe-profiles__card-text">'. $profile_for_exhibitors .'</div>
                </div>
            </div>
            ...
            <div id="profile_industry_scope" class="pwe-profiles__card" style="background: url('. $profile_industry_scope_img .'), url(' . $default_industry_img . ')">
                <div class="pwe-profiles__card-content">
                    <p>'. PWE_Functions::multi_translation("profiles_subtitle") .'</p>
                    <h5>'. PWE_Functions::multi_translation("industry") .'</h5>
                    <div class="pwe-profiles__show-more-btn">
                        <span>'. PWE_Functions::multi_translation("more_btn") .'</span>
                        <span class="pwe-profiles__show-more-arrow">
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="pwe-profiles__card-text">'. $profile_industry_scope .'</div>
                </div>
            </div>
        </div>
    </div>
