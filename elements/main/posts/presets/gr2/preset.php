...
<div id="pwePosts" class="pwe-posts">
    <div class="pwe-posts__wrapper">
        <div class="pwe-posts__title">
            <h4 class="pwe-main-title">'. PWE_Functions::languageChecker('Expo Aktualności', 'Expo News') .'</h4>
