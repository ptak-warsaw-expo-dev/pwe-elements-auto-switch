    ...
    <div class="pwe-logotypes__wrapper">
        ...
        if ($logotypes_slug === 'patrons-partners' || $logotypes_slug === 'patrons-partners-international') {
            ...
            <div class="pwe-logotypes__button pwe-main-btn--primary">
                <a class="" href="'. ($b2c ? PWE_Functions::multi_translation("ticket_url") : PWE_Functions::multi_translation("reg_url")) .'">
                    '. ($b2c ? PWE_Functions::multi_translation("buy_ticket") : PWE_Functions::multi_translation("take_part")) .'
                </a> 
            </div>';
        }
