...
<div id="pweOtherEvents" class="pwe-other-events">
    <div class="pwe-other-events__wrapper">
        <div class="pwe-other-events__title">
            <h4 class="pwe-other-events__heading pwe-main-title">'. PWECommonFunctions::languageChecker('Inne wydarzenia', 'Other events') .'</h4>
            <p>'. PWECommonFunctions::languageChecker('Podczas targów', 'During the fair') .'</p>
        </div>
