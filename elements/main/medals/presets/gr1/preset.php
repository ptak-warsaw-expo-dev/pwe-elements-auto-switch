...
<div id="pweMedals" class="pwe-medals">
    <div class="pwe-medals__hero">
        ...
        <div class="pwe-medals__hero-image-wrapper">
            <img src="' . (PWE_Functions::lang_pl() ? '/wp-content/plugins/pwe-media/media/medals/gr1/medal_img_pl.webp' : '/wp-content/plugins/pwe-media/media/medals/gr1/medal_img_en.webp') . '" alt="Medale Ptak Warsaw Expo" class="pwe-medals__hero-image">
        </div>
    </div>
