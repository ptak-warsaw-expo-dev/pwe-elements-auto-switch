    ...
    <div class="pwe-conference-schedule__wrapper">
        ...
        <div class="pwe-conference-schedule__top">
            <div class="pwe-conference-schedule__title-container">
                <h2 class="pwe-subtitle">'. PWE_Functions::multi_translation("conferences") .'</h2> 
                    ...
                    <tr>
                        <th>
                            <div class="pwe-conference-schedule__column-title">
                                ...
                                <p>' . PWE_Functions::multi_translation("organizer") . '</p>
                            </div>
                        </th>
                        <th>
                            <div class="pwe-conference-schedule__column-title">
                                ...
                                <p>' . PWE_Functions::multi_translation("subject") . '</p>
                            </div>
                        </th>
                        <th>
                            <div class="pwe-conference-schedule__column-title">
                                ...
                                <p>' . PWE_Functions::multi_translation("date") . '</p>
                            </div>
                        </th>
                    </tr>
                </thead>
                    ...
                    <div class="pwe-conference-schedule__buttons">
                        <div class="pwe-btn-container header-button">
                            <a class="pwe-link pwe-btn btn-visitors" 
                                ...
                                alt="'. ($b2c ? (PWE_Functions::languageChecker('link do biletów', 'link to tickets')) : (PWE_Functions::languageChecker('link do rejestracji', 'link to registration'))) .'">
                        ...
                        <div class="pwe-btn-container header-button">
                            <a class="pwe-link pwe-btn btn-more" 
                                ...
                                '. PWE_Functions::multi_translation("find_more") .' 
