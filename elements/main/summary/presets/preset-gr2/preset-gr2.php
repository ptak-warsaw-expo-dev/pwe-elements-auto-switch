...
<div class="pwe-summary">
    ...
    <div class="pwe-summary__heading">
        <div class="pwe-summary__heading-text">
            ...
            <h2 class="pwe-summary__title pwe-main-title">Największe Centrum Targowe w Europie Środkowo-Wschodniej</h2>
        </div>
