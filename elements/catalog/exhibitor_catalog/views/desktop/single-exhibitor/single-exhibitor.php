        ...
        <div class="exhibitor-page__content">
            ...
            if (!empty($desc)) {
                ...
                <div class="exhibitor-page__desc">
                    <h2 class="exhibitor-page__subtitle">' . PWECommonFunctions::languageChecker('Opis', 'Description') . '</h2>
            ...
            if (!empty($why_visit)) {
                ...
                <div class="exhibitor-page__benefits">
                    <h2 class="exhibitor-page__subtitle">' . PWECommonFunctions::languageChecker('Dlaczego warto odwiedzić nasze stoisko', 'Why you should visit our stand') . '</h2>
            ...
            if (!empty($brands)) {
                ...
                <div class="exhibitor-page__brands swiper">
                    <h2 class="exhibitor-page__subtitle">' . PWECommonFunctions::languageChecker('Marki, które reprezentujemy', 'Brands we represent') . '</h2>
            ...
            if (!empty($catalog_tags)) {
                ...
                <div class="exhibitor-page__technologies">
                    <h2 class="exhibitor-page__subtitle">' . PWECommonFunctions::languageChecker('Sektory Branżowe', 'Industry Sectors') . '</h2>
            ...
            if (!empty(array_filter(array_column($products, 'tags')))) {
                ...
                // 1. Zbieramy wszystkie kategorie do jednej tablicy
                $all_categories = [];
                ...
                if (!empty($unique_categories)) {
                    ...
                    <div class="exhibitor-page__products-category">
                        <h2 class="exhibitor-page__subtitle">' . PWECommonFunctions::languageChecker('Kategorie produktów', 'Product categories') . '</h2>
                        <div class="exhibitor-page__products-category-list">';

                            foreach ($unique_categories as $single_category) {
                                $output .= '
            ...
            <div class="exhibitor-page__products-tabs">
                ...
                <div class="exhibitor-page__tabs-nav">';
                    if (!empty($products)) {
                        $output .= '
                        <button class="exhibitor-page__tab-btn" data-tab="products">' . PWECommonFunctions::languageChecker('Produkty', 'Products') . ' <span class="exhibitor-page__tab-total">(' . $total_products . ')</span></button>';
                    }
                    if (!empty($documents)) {
                        $output .= '
                        <button class="exhibitor-page__tab-btn" data-tab="documents">' . PWECommonFunctions::languageChecker('Dokumenty', 'Documents') . ' <span class="exhibitor-page__tab-total">(' . $total_docs . ')</span></button>';
                    }
                $output .= '
                </div>';
