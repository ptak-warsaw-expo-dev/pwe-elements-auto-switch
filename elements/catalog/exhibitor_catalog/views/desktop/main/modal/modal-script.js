document.addEventListener('click', function (e) {
    const trigger = e.target.closest(
        '.exhibitor-single-mobile__product-item, .exhibitor-catalog__exh-card-files-product'
    );
    if (!trigger) return;
    if (document.querySelector('.exhibitor-product-modal')) return;
    ...
    const allProducts = container.querySelectorAll('.exhibitor-catalog__exh-card-files-product');
