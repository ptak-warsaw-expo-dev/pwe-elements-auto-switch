        ...
        <div class="exhibitor-single-mobile__content">
            ...
            if (!empty($desc)) {
                ...
                <div class="exhibitor-single-mobile__section">
                    <h2 class="exhibitor-single-mobile__section-title">Opis</h2>
                    <div class="exhibitor-single-mobile__section-body collapsible-text">' . $desc . '</div>
                    <button class="collapsible-toggle">Pokaż więcej</button>
                </div>';
            }
            ...
            if (!empty($why_visit)) {
                $output .= '
                <div class="exhibitor-single-mobile__section">
                    <h2 class="exhibitor-single-mobile__section-title">Dlaczego warto odwiedzić nasze stoisko</h2>
            ...
            if (!empty($brands)) {
                ...
                <div class="exhibitor-single-mobile__brands swiper">
                    <h2 class="exhibitor-single-mobile__section-title">Marki, które reprezentujemy</h2>
            ...
            if (!empty($catalog_tags)) {
                ...
                <div class="exhibitor-single-mobile__industries swiper">
                    <h2 class="exhibitor-single-mobile__section-title">Sektory Branżowe</h2>
            ...
            if (!empty(array_filter(array_column($products, 'tags')))) {
                ...
                <div class="exhibitor-single-mobile__categories swiper">
                    <h2 class="exhibitor-single-mobile__section-title">Kategorie produktów</h2>
