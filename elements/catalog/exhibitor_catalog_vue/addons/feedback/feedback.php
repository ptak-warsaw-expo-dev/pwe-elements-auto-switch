...
<div class="catalog-feedback">
    <button class="catalog-feedback__toggle" aria-label="Otwórz opinię">
    ...
    <button class="catalog-feedback__close" aria-label="Zamknij opinię">×</button>
    <h3>Jak oceniasz katalog?</h3>';
    ...
    echo '
    <p class="rating-hint">Twoja opinia jest anonimowa</p>
</div>';
