...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const langCurrent = document.querySelector(".pwe-menu-auto-switch__lang-current");
    const langDropdown = document.querySelector(".pwe-menu-auto-switch__lang-dropdown");

    langCurrent.addEventListener("click", function(e) {
        e.stopPropagation();
        langDropdown.classList.toggle("pwe-menu-auto-switch__lang-dropdown--open");
    });

    document.addEventListener("click", function(e) {
        if (!langCurrent.contains(e.target)) {
            langDropdown.classList.remove("pwe-menu-auto-switch__lang-dropdown--open");
        }
    });
});