...
class PWESwiperGr2
{
    ...
    public static function swiperScriptsGr2($id, $slides_per_view = 'auto', $breakpoints = [], $scrollbar = false)
    {
        ...
        $slides_per_view_val = ($slides_per_view === 'auto') ? '"auto"' : $slides_per_view;
        ...
        jQuery(function($){
            ...
            new Swiper("' . $id . ' .swiper", {
                slidesPerView: ' . $slides_per_view_val . ',
                spaceBetween: 20,
                grabCursor: true,
                loop: true,
                autoplay: {
