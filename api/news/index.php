...
function pwe_json_response($status_code, $data)
{
...
function pwe_assign_news_category($post_id, $language = 'pl')
{
    if (empty($post_id)) {
        return false;
    }
...
function pwe_prepare_uncode_raw_html($html)
{
    $html = (string) ($html ?? '');
...
function pwe_set_featured_image_from_url($image_url, $post_id, $title)
{
...
if ($action === 'delete') {
    ...
    $html_pl = pwe_prepare_uncode_raw_html($raw_html_pl);
    $html_en = pwe_prepare_uncode_raw_html($raw_html_en);
    ...
    pwe_assign_news_category($post_id_pl, 'pl');
    ...
    $featured_pl = pwe_set_featured_image_from_url($image_pl_url, $post_id_pl, $title_pl);
    ...
    pwe_assign_news_category($post_id_en, 'en');
    ...
    $featured_en = pwe_set_featured_image_from_url($image_en_url, $post_id_en, $title_en);
