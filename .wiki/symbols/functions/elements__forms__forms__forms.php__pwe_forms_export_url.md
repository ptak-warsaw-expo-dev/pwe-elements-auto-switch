# `pwe_forms_export_url()`

**Źródło:** `elements/forms/forms/forms.php:147`  
**Sygnatura:** `pwe_forms_export_url(string $filename)`

## Krótki opis

Realizuje logikę techniczną związaną z `pwe_forms_export_url`.
