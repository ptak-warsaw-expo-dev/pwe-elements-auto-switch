# `PWE_Phone_Validator_Addon::get_language()`

**Źródło:** `addons/phone-validator/phone-validator.php:211`  
**Sygnatura:** `private static get_language()`

## Krótki opis

Pobiera lub wylicza language zgodnie z logiką implementacji.
