# `PWE_Functions::get_database_elements_data()`

**Źródło:** `includes/class-functions.php:4048`  
**Sygnatura:** `public static get_database_elements_data()`

## Krótki opis

Pobiera lub wylicza database elements data zgodnie z logiką implementacji.
