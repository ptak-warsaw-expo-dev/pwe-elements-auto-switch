...
**Callback:** `show_trade_fair_first_day`  
**Źródło:** `includes/class-shortcodes.php:2604`

## Krótki opis

Zwraca pierwszy dzień targów.

## Jak działa

1. Shortcode jest rejestrowany podczas hooka `init` (priorytet 20) przez `PWE_Shortcodes::register_shortcodes()`.
2. WordPress wywołuje callback `show_trade_fair_first_day`.
3. Odczytuje ustawienia WordPress: `trade_fair_first_day`.
