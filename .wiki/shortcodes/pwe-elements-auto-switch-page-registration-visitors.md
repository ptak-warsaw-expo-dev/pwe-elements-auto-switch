# `[pwe-elements-auto-switch-page-registration-visitors]`

Renderuje pełną kompozycję strony typu **`registration-visitors`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Registration_Visitors` | — | domyślnie 1 |
