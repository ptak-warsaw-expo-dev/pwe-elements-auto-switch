# `[sc_pwe_text_registration]`

**Kategoria:** SEO / teksty  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `sc_pwe_text_registration`  
**Źródło:** `includes/class-shortcodes.php:3528`
...
2. WordPress wywołuje callback `sc_pwe_text_registration`.
