...
Zwraca URL strony opisanej kluczem `kontakt` w języku bieżącym lub podanym przez atrybut `lang`. Może zwrócić adres absolutny po ustawieniu `absolute=true`.
