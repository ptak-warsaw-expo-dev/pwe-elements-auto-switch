# `[trade_fair_contact_medal_ceremony_email]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_medal_ceremony_email`  
**Źródło:** `includes/class-shortcodes.php:3005`
...
2. WordPress wywołuje callback `show_trade_fair_contact_medal_ceremony_email`.
