...
**Callback:** `sc_pwe_text_contact`  
**Źródło:** `includes/class-shortcodes.php:3512`
...
2. WordPress wywołuje callback `sc_pwe_text_contact`.
3. Callback korzysta z innych shortcode’ów jako źródła/fallbacku: `[trade_fair_name]`, `[trade_fair_name_eng]`.
