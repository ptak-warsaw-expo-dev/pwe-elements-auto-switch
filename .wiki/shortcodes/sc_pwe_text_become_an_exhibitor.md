# `[sc_pwe_text_become_an_exhibitor]`

**Kategoria:** SEO / teksty  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `sc_pwe_text_become_an_exhibitor`  
**Źródło:** `includes/class-shortcodes.php:3544`
...
2. WordPress wywołuje callback `sc_pwe_text_become_an_exhibitor`.
