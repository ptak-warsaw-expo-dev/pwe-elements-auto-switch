# `[sc_pwe_text_for_exhibitors]`

**Kategoria:** SEO / teksty  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `sc_pwe_text_for_exhibitors`  
**Źródło:** `includes/class-shortcodes.php:3464`
...
2. WordPress wywołuje callback `sc_pwe_text_for_exhibitors`.
