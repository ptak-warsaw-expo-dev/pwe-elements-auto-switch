# `[pwe-elements-auto-switch-page-exhibitor-visitor-generator]`

Renderuje pełną kompozycję strony typu **`exhibitor-visitor-generator`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Exhibitor_Visitor_Generator` | — | domyślnie 1 |
