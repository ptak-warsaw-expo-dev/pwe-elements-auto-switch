# `[trade_fair_contact_media_person_name]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_media_person_name`  
...
2. WordPress wywołuje callback `show_trade_fair_contact_media_person_name`.
