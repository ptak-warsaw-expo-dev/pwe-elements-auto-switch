# `[trade_fair_contact_media_person_name_2]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_media_person_name_2`  
...
2. WordPress wywołuje callback `show_trade_fair_contact_media_person_name_2`.
