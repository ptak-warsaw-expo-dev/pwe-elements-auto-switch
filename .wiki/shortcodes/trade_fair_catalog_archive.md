# `[trade_fair_catalog_archive]`

**Kategoria:** Katalog  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_catalog_archive`  
**Źródło:** `includes/class-shortcodes.php:2642`
...
2. WordPress wywołuje callback `show_trade_fair_catalog_archive`.
3. Callback korzysta z innych shortcode’ów jako źródła/fallbacku: `[pwe_catalog_archive]`.
4. Odczytuje ustawienia WordPress: `pwe_general_options`, `trade_fair_catalog_archive`.
