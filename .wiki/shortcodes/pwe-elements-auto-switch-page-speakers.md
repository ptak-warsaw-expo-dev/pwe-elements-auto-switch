# `[pwe-elements-auto-switch-page-speakers]`

Renderuje pełną kompozycję strony typu **`speakers`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Simple_Header` | — | domyślnie 1 |
| 2 | `Speakers_Page` | — | domyślnie 1 |
