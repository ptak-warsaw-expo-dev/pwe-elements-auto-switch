# `[pwe-elements-auto-switch-page-exhibitor-worker-generator]`

Renderuje pełną kompozycję strony typu **`exhibitor-worker-generator`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Exhibitor_Worker_Generator` | — | domyślnie 1 |
