# `elements/layout/layout/layout.php`

Element strony AutoSwitch implementowany przez `Layout`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 1470 B
- **Liczba linii:** 53
- **Źródło:** `elements/layout/layout/layout.php`
