# `elements/main/combined-events/combined-events.php`

Element strony AutoSwitch implementowany przez `Combined_Events`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 1727 B
- **Liczba linii:** 49
- **Źródło:** `elements/main/combined-events/combined-events.php`

## Klasy i metody

### `Combined_Events` — linia 4
