# `elements/main/tickets/tickets.php`

Element strony AutoSwitch implementowany przez `Tickets`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 3531 B
- **Liczba linii:** 80
- **Źródło:** `elements/main/tickets/tickets.php`
