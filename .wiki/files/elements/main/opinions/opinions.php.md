# `elements/main/opinions/opinions.php`

Element strony AutoSwitch implementowany przez `Opinions`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 5953 B
- **Liczba linii:** 132
- **Źródło:** `elements/main/opinions/opinions.php`
