# `elements/main/header/widgets/partners/b2c-new/preset.php`

Element strony AutoSwitch; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 5024 B
- **Liczba linii:** 124
- **Źródło:** `elements/main/header/widgets/partners/b2c-new/preset.php`
