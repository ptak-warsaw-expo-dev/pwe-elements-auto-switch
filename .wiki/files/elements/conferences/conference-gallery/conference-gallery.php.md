# `elements/conferences/conference-gallery/conference-gallery.php`

Element strony AutoSwitch implementowany przez `Conference_Gallery`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 1280 B
- **Liczba linii:** 46
- **Źródło:** `elements/conferences/conference-gallery/conference-gallery.php`

## Klasy i metody

### `Conference_Gallery` — linia 4

- `public static get_data()` — linia 6
- `public static render($group = '', $params = [], $atts = [])` — linia 15
