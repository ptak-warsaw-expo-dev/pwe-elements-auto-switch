# `elements/registration-visitors/registration-visitors/presets/platyna/preset.php`
...
- **Rozmiar:** 1995 B
- **Liczba linii:** 55
- **Źródło:** `elements/registration-visitors/registration-visitors/presets/platyna/preset.php`
