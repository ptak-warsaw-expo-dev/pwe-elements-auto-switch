# `elements/registration-visitors/registration-visitors/presets/premium/preset.php`
...
- **Rozmiar:** 1109 B
- **Liczba linii:** 35
- **Źródło:** `elements/registration-visitors/registration-visitors/presets/premium/preset.php`

## Wybrane zależności wywołań

- `PWE_Functions::multi_translation()`
- `PWE_Functions::render_component()`
