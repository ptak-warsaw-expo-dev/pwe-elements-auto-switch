# `elements/exhibitor-visitor-generator/exhibitor-visitor-generator/exhibitor-visitor-generator.php`

Element strony AutoSwitch implementowany przez `Exhibitor_Visitor_Generator`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 3509 B
- **Liczba linii:** 106
- **Źródło:** `elements/exhibitor-visitor-generator/exhibitor-visitor-generator/exhibitor-visitor-generator.php`

## Klasy i metody

### `Exhibitor_Visitor_Generator` — linia 4

- `public static get_data()` — linia 6
- `public static render($group = '', $params = [], $atts = [])` — linia 16
