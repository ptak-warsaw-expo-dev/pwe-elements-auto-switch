# `elements/contact/contact/contact.php`

Element strony AutoSwitch implementowany przez `Contact`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 1437 B
- **Liczba linii:** 53
- **Źródło:** `elements/contact/contact/contact.php`
