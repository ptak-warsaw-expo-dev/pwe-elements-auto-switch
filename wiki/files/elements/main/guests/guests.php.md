# `elements/main/guests/guests.php`

Element strony AutoSwitch implementowany przez `Guests`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 4895 B
- **Liczba linii:** 147
- **Źródło:** `elements/main/guests/guests.php`
