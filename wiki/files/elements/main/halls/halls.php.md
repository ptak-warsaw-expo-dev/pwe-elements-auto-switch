# `elements/main/halls/halls.php`

Element strony AutoSwitch implementowany przez `Halls`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 5473 B
- **Liczba linii:** 128
- **Źródło:** `elements/main/halls/halls.php`
