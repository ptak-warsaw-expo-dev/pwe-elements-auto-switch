# `elements/main/sectors/sectors.php`

Element strony AutoSwitch implementowany przez `Sectors`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 3149 B
- **Liczba linii:** 85
- **Źródło:** `elements/main/sectors/sectors.php`
