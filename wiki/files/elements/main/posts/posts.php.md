# `elements/main/posts/posts.php`

Element strony AutoSwitch implementowany przez `Posts`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 5377 B
- **Liczba linii:** 133
- **Źródło:** `elements/main/posts/posts.php`
