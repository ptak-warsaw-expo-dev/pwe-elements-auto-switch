# `elements/step2/step2/step2.php`

Element strony AutoSwitch implementowany przez `Step2`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 2504 B
- **Liczba linii:** 76
- **Źródło:** `elements/step2/step2/step2.php`
