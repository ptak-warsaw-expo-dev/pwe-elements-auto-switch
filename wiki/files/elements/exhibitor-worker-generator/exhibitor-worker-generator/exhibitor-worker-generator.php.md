# `elements/exhibitor-worker-generator/exhibitor-worker-generator/exhibitor-worker-generator.php`

Element strony AutoSwitch implementowany przez `Exhibitor_Worker_Generator`; zwykle deklaruje `get_data()` i `render()`.
...
- **Rozmiar:** 2639 B
- **Liczba linii:** 84
- **Źródło:** `elements/exhibitor-worker-generator/exhibitor-worker-generator/exhibitor-worker-generator.php`

## Klasy i metody

### `Exhibitor_Worker_Generator` — linia 4
