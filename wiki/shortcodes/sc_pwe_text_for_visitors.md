# `[sc_pwe_text_for_visitors]`

**Kategoria:** SEO / teksty  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `sc_pwe_text_for_visitors`  
**Źródło:** `includes/class-shortcodes.php:3456`
...
2. WordPress wywołuje callback `sc_pwe_text_for_visitors`.
