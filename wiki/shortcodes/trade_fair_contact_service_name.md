# `[trade_fair_contact_service_name]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_service_name`  
**Źródło:** `includes/class-shortcodes.php:2953`
...
2. WordPress wywołuje callback `show_trade_fair_contact_service_name`.
