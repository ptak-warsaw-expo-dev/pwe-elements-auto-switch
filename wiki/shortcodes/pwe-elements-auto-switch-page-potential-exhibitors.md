# `[pwe-elements-auto-switch-page-potential-exhibitors]`

Renderuje pełną kompozycję strony typu **`potential-exhibitors`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Potential_Exhibitors` | — | domyślnie 1 |
