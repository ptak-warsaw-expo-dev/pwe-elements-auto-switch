# `[trade_fair_contact_phone_vip]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_phone_vip`  
**Źródło:** `includes/class-shortcodes.php:3001`
...
2. WordPress wywołuje callback `show_trade_fair_contact_phone_vip`.
