# `[trade_fair_contact_media_name]`

**Kategoria:** Kontakt / rejestracja  
**Rejestracja:** `PWE_Shortcodes::register_shortcodes()`  
**Callback:** `show_trade_fair_contact_media_name`  
**Źródło:** `includes/class-shortcodes.php:2969`
...
2. WordPress wywołuje callback `show_trade_fair_contact_media_name`.
