# `[pwe-elements-auto-switch-page-call-center]`

Renderuje pełną kompozycję strony typu **`call-center`** przez `PWE_Elements::render_elements()`.
