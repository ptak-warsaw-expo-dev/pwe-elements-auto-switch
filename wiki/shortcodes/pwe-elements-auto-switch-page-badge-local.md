# `[pwe-elements-auto-switch-page-badge-local]`

Renderuje pełną kompozycję strony typu **`badge-local`** przez `PWE_Elements::render_elements()`.
