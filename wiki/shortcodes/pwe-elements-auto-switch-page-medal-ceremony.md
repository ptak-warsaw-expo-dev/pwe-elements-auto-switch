# `[pwe-elements-auto-switch-page-medal-ceremony]`

Renderuje pełną kompozycję strony typu **`medal-ceremony`** przez `PWE_Elements::render_elements()`.
