# `[pwe-elements-auto-switch-page-confirmation-visitors-registration]`

Renderuje pełną kompozycję strony typu **`confirmation-visitors-registration`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Confirmation_Visitors_Registration` | — | domyślnie 1 |
