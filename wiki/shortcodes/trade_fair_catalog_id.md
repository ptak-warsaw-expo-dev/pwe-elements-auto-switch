...
**Callback:** `show_trade_fair_catalog_id`  
**Źródło:** `includes/class-shortcodes.php:2635`
...
2. WordPress wywołuje callback `show_trade_fair_catalog_id`.
3. Callback korzysta z innych shortcode’ów jako źródła/fallbacku: `[pwe_catalog_id]`.
4. Odczytuje ustawienia WordPress: `pwe_general_options`, `trade_fair_catalog_id`.
