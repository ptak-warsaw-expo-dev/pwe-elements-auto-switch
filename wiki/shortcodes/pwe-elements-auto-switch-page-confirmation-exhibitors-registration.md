# `[pwe-elements-auto-switch-page-confirmation-exhibitors-registration]`

Renderuje pełną kompozycję strony typu **`confirmation-exhibitors-registration`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Confirmation_Exhibitors_Registration` | — | domyślnie 1 |
