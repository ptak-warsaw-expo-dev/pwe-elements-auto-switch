# `[pwe-elements-auto-switch-page-conferences]`

Renderuje pełną kompozycję strony typu **`conferences`** przez `PWE_Elements::render_elements()`.
...
|---:|---|---|---|
| 1 | `Side_Events` | — | domyślnie 1 |
| 2 | `Conference_Gallery` | — | domyślnie 1 |
| 3 | `Footer` | — | domyślnie 1 |
