...
**Callback:** `show_trade_fair_registration_benefits_en`  
**Źródło:** `includes/class-shortcodes.php:3035`

## Krótki opis

Zwraca wartość „registration benefits en” dla bieżących targów, z fallbackami z konfiguracji/shortcodów danych.

## Jak działa

1. Shortcode jest rejestrowany podczas hooka `init` (priorytet 20) przez `PWE_Shortcodes::register_shortcodes()`.
2. WordPress wywołuje callback `show_trade_fair_registration_benefits_en`.
3. Odczytuje ustawienia WordPress: `trade_fair_registration_benefits_en`.
