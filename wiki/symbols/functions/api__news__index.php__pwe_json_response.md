...
**Źródło:** `api/news/index.php:7`  
**Sygnatura:** `pwe_json_response($status_code, $data)`

## Krótki opis

Realizuje logikę techniczną związaną z `pwe_json_response`.
...
- [Dokument pliku](../../files/api/news/index.php.md)
