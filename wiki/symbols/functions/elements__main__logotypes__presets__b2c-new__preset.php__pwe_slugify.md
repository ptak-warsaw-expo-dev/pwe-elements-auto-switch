...
**Źródło:** `elements/main/logotypes/presets/b2c-new/preset.php:7`  
**Sygnatura:** `pwe_slugify($text)`

## Krótki opis

Realizuje logikę techniczną związaną z `pwe_slugify`.
...
- [Dokument pliku](../../files/elements/main/logotypes/presets/b2c-new/preset.php.md)
