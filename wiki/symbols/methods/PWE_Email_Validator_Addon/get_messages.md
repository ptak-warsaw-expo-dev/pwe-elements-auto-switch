# `PWE_Email_Validator_Addon::get_messages()`

**Źródło:** `addons/email-validator/email-validator.php:176`  
**Sygnatura:** `private static get_messages()`

## Krótki opis

Pobiera lub wylicza messages zgodnie z logiką implementacji.
