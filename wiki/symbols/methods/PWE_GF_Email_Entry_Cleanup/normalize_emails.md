# `PWE_GF_Email_Entry_Cleanup::normalize_emails()`

**Źródło:** `includes/class-hooks.php:206`  
**Sygnatura:** `private static normalize_emails($emails)`

## Krótki opis

Realizuje logikę techniczną związaną z `normalize_emails`.
