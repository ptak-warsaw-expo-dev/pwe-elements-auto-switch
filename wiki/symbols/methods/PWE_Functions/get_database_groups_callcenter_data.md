# `PWE_Functions::get_database_groups_callcenter_data()`

**Źródło:** `includes/class-functions.php:2550`  
**Sygnatura:** `public static get_database_groups_callcenter_data()`

## Krótki opis

Pobiera lub wylicza database groups callcenter data zgodnie z logiką implementacji.
