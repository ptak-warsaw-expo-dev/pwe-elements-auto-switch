# `PWE_Functions::get_database_elements_order_data()`

**Źródło:** `includes/class-functions.php:4141`  
**Sygnatura:** `public static get_database_elements_order_data()`

## Krótki opis

Pobiera lub wylicza database elements order data zgodnie z logiką implementacji.
