# `PWE_Functions::get_database_store_packages_data()`

**Źródło:** `includes/class-functions.php:2269`  
**Sygnatura:** `public static get_database_store_packages_data()`

## Krótki opis

Pobiera lub wylicza database store packages data zgodnie z logiką implementacji.
