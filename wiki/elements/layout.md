...
**Plik:** `elements/layout/layout/layout.php`  
**Klasa:** `Layout` (linia 4)  
**Shortcode:** `[pwe-elements-auto-switch-layout]`
...
- `all` → `elements/layout/layout/presets/all/preset.php`

## Mechanizm renderowania

1. `PWE_Elements` rejestruje shortcode dynamicznie na podstawie klasy.
2. Przy wywołaniu ładowana jest klasa `Layout` i uruchamiana jest jej metoda `render()`.
...
- [Dokument pliku](../files/elements/layout/layout/layout.php.md)
